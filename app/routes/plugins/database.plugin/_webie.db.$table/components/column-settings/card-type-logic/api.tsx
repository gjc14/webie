...
export const APISettingCard = ({ className }: { className?: string }) => {
    ...
    return (
        <Card className={cn('', className)}>
            <CardHeader>
                <CardTitle>
                    API URL (Dynamic ard based on type, this is just an example)
                </CardTitle>
                <CardDescription>
                    API URL is used to fetch data for this column. The data will
            ...
            <CardFooter className="">
                <Button onClick={() => method && testAPI(method)}>
                    Test API
                </Button>
            </CardFooter>
        </Card>
